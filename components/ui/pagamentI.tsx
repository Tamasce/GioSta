...
const PayPalCheckoutI = () => {
  const [showPayPal, setShowPayPal] = useState(false);
  const pdfUrl = "/Scheda Allenamento Intermedio.pdf"; // Sostituisci con il percorso corretto del PDF

  const handleDownload = () => {
    const link = document.createElement("a");
    link.href = pdfUrl;
    link.download = "Scheda_Allenamento_Intermedio.pdf";
...
export default PayPalCheckoutI;