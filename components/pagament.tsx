...
const PayPalCheckoutP = () => {
  const [showPayPal, setShowPayPal] = useState(false);
  const pdfUrl = "/Scheda Allenamento Principiante.pdf"; // Sostituisci con il percorso corretto del PDF

  const handleDownload = () => {
    const link = document.createElement("a");
    link.href = pdfUrl;
    link.download = "Scheda_Allenamento_Principiante.pdf";
...
export default PayPalCheckoutP;